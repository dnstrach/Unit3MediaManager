...
import UIKit
import CoreData
import UserNotifications //for permission requests
...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    //solve in-app notifications
    //f your app is in foreground mode, this function will run, even if the notification itself does not
    //So, from here, you can trigger a notification that can be observed from anywhere in your app
    //This solves the in-app notification, and also sends out a notification to your code base
